// enemy_lary - Destroy Event
// When this enemy dies, add gold coins and spawn flying coin animations

// Add gold coins to global
global.gold_coins += global.enemy_lary_coins;

// Calculate number of flying coins to spawn (each coin represents 5)
var _num_coins = max(1, ceil(global.enemy_lary_coins / 5));
